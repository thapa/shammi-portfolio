...
const IphoneFrame = ({ children, className = "" }) => {
  ...
  return (
    ...
    <div
      ...
      {/* Status Bar */}
      <div
        className="absolute top-0 left-0 right-0 h-8 z-20 px-6 flex justify-between items-center text-black dark:text-white dark:bg-[#212121] bg-white">
        {/* Left side - Time */}
      ...
      {/* The screen area */}
      <div
        className="w-full h-full rounded-[34px] overflow-hidden pt-8">
        {children}
      </div>
      {/* Side Buttons */}
      {/* Volume Up */}
